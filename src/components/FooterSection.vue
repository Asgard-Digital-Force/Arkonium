<template>
  <footer class="bg-[#0B141D] text-[--accent] text-center py-8 mt-8">

    <p class="text-ark-accent font-bold text-lg mb-2">
      Arkonium
    </p>
    <p class="text-ark-text text-sm max-w-xl mx-auto mb-4">
